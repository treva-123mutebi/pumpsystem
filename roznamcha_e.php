...
$(function() {
 ...
 <!-- CHART & CHAT  SECTION -->
                 <div class="row">
                                    ...
                                    <div class="col-lg-12">
                                            ...
                                            <a href="#" onclick="loadcat22()" class="btn btn-primary">Generate Roznamcha</a>
 ...
 <!-- CHART & CHAT  SECTION -->
                 ...
                 <tr>
          <td width="100%" align="center" style=" background-color:red" colspan="3"><strong><label style="color:white">OPENING</label></strong></td></tr>
          <tr style="height:20px">
          <td width="50%" colspan="2"><strong>CASH</strong></td>
          <td width="50%"><strong>100 PKR</strong></td></tr>
          <tr>
           <tr>
          <td width="50%" colspan="2"><strong>FUEL</strong></td>
          <td width="50%"><strong>9000 Ltrs</strong></td></tr>
          <tr>
          <td width="25%"><strong></strong></td>
          <td width="25%"><strong>Nosel 1.</strong></td>
          <td width="50%"><strong>1500 ltrs</strong></td>
          </tr>
          <tr>
          <td width="25%"><strong></strong></td>
          <td width="25%"><strong>Nosel 2.</strong></td>
          <td width="50%"><strong>1500 ltrs</strong></td>
          </tr>
          <tr>
          <td width="25%"><strong></strong></td>
          <td width="25%"><strong>Nosel 3.</strong></td>
          <td width="50%"><strong>1500 ltrs</strong></td>
          </tr>
          <tr>
          <td width="25%"><strong></strong></td>
          <td width="25%"><strong>Nosel 4.</strong></td>
          <td width="50%"><strong>1500 ltrs</strong></td>
          </tr>
          <tr>
          <td width="25%"><strong></strong></td>
          <td width="25%"><strong>Nosel 5.</strong></td>
          <td width="50%"><strong>1500 ltrs</strong></td>
          </tr>
          <tr>
          <td width="25%"><strong></strong></td>
          <td width="25%"><strong>Nosel 6.</strong></td>
          <td width="50%"><strong>1500 ltrs</strong></td>
          </tr>
            <tr>
          <td width="50%" colspan="2"><strong>Fuel Purchase</strong></td>
          <td width="50%"><strong>100 Ltr</strong></td></tr>
          <tr>
            <tr>
          <td width="50%" colspan="2"><strong>Payments (Amount)</strong></td>
          <td width="50%"><strong>100 PKR</strong></td></tr>
          <tr>
            <tr>
          <td width="50%" colspan="2"><strong>Sale</strong></td>
          <td width="50%"><strong>100 PKR</strong></td></tr>
          <tr>
            <tr>
          <td width="50%" colspan="2"><strong>Recoveries</strong></td>
          <td width="50%"><strong>100 PKR</strong></td></tr>
          <tr>
            <tr>
          <td width="50%" colspan="2"><strong>Expences</strong></td>
          <td width="50%"><strong>100 PKR</strong></td></tr>
          <tr>
          <tr>
          <td width="100%" align="center" style=" background-color:red" colspan="3"><strong><label style="color:white">CLOSING</label></strong></td></tr>
          <tr>
           <tr>
          <td width="50%" colspan="2"><strong>FUEL</strong></td>
          <td width="50%"><strong>9000 Ltrs</strong></td></tr>
