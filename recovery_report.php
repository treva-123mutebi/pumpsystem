                 ...
                 <div class="row">
                                    ...
                                    <div class="col-lg-12">
                                            ...
                                            <input type="text" id="datepicker" required="" name="date" class="hasDatepicker">
                                             <label>To</label>
                                            <input type="text" id="datepicker2" required="" name="date2" class="hasDatepicker">
                                              <input type="hidden" name="inst" id="inst" value="4">
                                            <a href="#" onclick="loadcat22()" class="btn btn-primary">SHOW</a>
                                            <hr style="border-top: 1px dotted #f00;color: #fff;background-color: #fff;height: 1px;width:100%; ">
...
$.ajax({
      type : 'POST',
      data : {val1:id1,to:id2},
      url  : 'fetch_recovery_report.php',
