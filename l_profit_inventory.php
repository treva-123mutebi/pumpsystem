 ...
 <!-- CHART & CHAT  SECTION -->
                 <div class="row">
                                    ...
                                    <div class="col-lg-6">
                                            ...
                                            <input type="text" id="datepicker" required="" name="date" class="hasDatepicker"><br>
                                            <label>To Date</label>
                                            <input type="text" id="datepicker2" required="" name="date" class="hasDatepicker"><br>
                                            <select class="form-control" id="user_id" name="user_id">
                                                                                        <option value="50">10R2</option>
                                                                                        <option value="51">4R2</option>
                                                                                        <option value="52">4R1</option>
                                                                                        <option value="53">1R1</option>
                                            						                    </select>
                                             <br>
...
$.ajax({
      type : 'POST',
      data : {val1:id1,val2:id2,type:id3},
      url  : 'fetch_flow_l_l.php',
