					 ...
					 <div class="modal-dialog modal-sm">
                      <div class="modal-content">
                        ...
                        <div class="modal-header">
                          ...
                          <h4 class="modal-title" id="myModalLabel2">Edit Supplier Details</h4>
                        </div>
                        <div class="modal-body">
                         <form method = "POST" action = "update_supplier.php"> 
						   <input type="hidden" name="supplier_id" value="<?php echo $id;?>">
								<label>Name</label>
									<input type="text" name = "supplier_name" class="form-control" value = "<?php echo $row1['supplier_name'];?>">
									<br/>								
								<label>Address</label>
									<input type="text" name = "supplier_address" class="form-control" value = "<?php echo $row1['supplier_address'];?>">
									<br/>
								<label>Contact #</label>
