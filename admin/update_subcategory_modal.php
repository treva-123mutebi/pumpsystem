					 ...
					 <div class="modal-dialog modal-sm">
                      <div class="modal-content">
                        ...
                        <div class="modal-header">
                          ...
                          <h4 class="modal-title" id="myModalLabel2">Edit  Sub Category Name</h4>
                        </div>
                        <div class="modal-body">
                         <form method = "POST" action = "update_subcategory.php"> 
						   <input type="hidden" name="sc_id" value="<?php echo $id;?>">
								<label>Product Sub Category Name</label>
									<input type="text" name = "sc_name" class="form-control" value = "<?php echo $row1['sc_name'];?>">
									<br/>								
