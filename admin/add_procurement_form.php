<div class="x_panel">
                  <div class="x_title">
                    <h2>Add Procurement User <i class = "fa fa-users"></i></h2>
                  ...
                  <div class="x_content">
                    <br />
                    <form class="form-horizontal form-label-left" action = "add_procurement.php" method = "POST" enctype = "multipart/form-data">
