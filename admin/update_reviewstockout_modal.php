					 ...
					 <div class="modal-dialog modal-sm">
                      <div class="modal-content">
                        ...
                        <div class="modal-body">
                         <form method = "POST" action = "add_stockoutapproval.php"> 
						   <input type="hidden" name="reviewsales_id" value="<?php echo $id;?>">
								<label>Transaction Status</label>
									<input type="text" name = "cust_last" class="form-control" value = "<?php echo $row1['reviewstatus'];?>" readonly>
									<br/>								
								<label></label>
								<table class="table table-striped table-bordered">
									...
									<tbody>
									<?php
									$query2=mysqli_query($con,"select * from reviewsales_details natural join product natural join category where reviewsales_id='$id'")or die(mysqli_error($con));
									while($row2=mysqli_fetch_array($query2)){
										$id=$row2['reviewsalesdetails_id'];
										$total= $row2['sales_qty']*$row2['price'];
									...
									?>	
										<tr>
											...
											<td><input type="text" name = "price" class="form-control" value = "<?php echo $row2['price'];?>" readonly></td>
						...
						<form method = "POST" action = "stockoutdecline.php">
