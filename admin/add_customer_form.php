<div class="x_panel">
                  <div class="x_title">
                    <h2>Add Department <i class = "fa fa-building"></i></h2>
                  ...
                  <div class="x_content">
                    <br />
                    <form class="form-horizontal form-label-left" action = "add_customer.php" method = "POST" enctype = "multipart/form-data">
                      <div class="form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-3">Name</label>
                        <div class="col-md-9 col-sm-9 col-xs-9">
                          <input type="text" class="form-control" name = "cust_last">
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-9 col-sm-9 col-xs-9">
                          <textarea style = "resize:none;" name = "cust_address" class="form-control"></textarea>
