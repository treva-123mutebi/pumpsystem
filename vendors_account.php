 ...
 <!-- CHART & CHAT  SECTION -->
                 <div class="row">
                  ...
                  <select id="head" data-placeholder="Choose a Country" class="form-control chzn-select" tabindex="-1" name="head_one" style="display: none;">
						                    ...
						                    </select><div class="chosen-container chosen-container-single" style="width: 649px;" title="" id="head_chosen"><a class="chosen-single" tabindex="-1"><span>Select Head</span><div><b></b></div></a><div class="chosen-drop"><div class="chosen-search"><input type="text" autocomplete="off" tabindex="2"></div><ul class="chosen-results"></ul></div></div><br><br>
