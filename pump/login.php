...
$query=mysqli_query($con,"select * from user natural join branch where username='$user' and password='$pass' and branch_id='5' and status='active'")or die(mysqli_error($con));
    ...
    $query1=mysqli_query($con,"select * from payment natural join customer where branch_id='5' and status<>'paid'")or die(mysqli_error($con));
