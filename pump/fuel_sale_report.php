...
$(function() {
 ...
 <!-- CHART & CHAT  SECTION -->
                 <div class="row">
                                    ...
                                    <div class="col-lg-12">
                                            ...
                                            <label>To Date</label>
                                            <input type="text" id="datepicker2" required="" name="date" class="hasDatepicker">
 ...
 <!-- CHART & CHAT  SECTION -->
                 ...
                 <h4>Select from and to date for the results filter</h4>
          </div>
                     </div>
                </div>
