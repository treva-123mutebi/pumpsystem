                 ...
                 <div class="row">
                                    ...
                                    <div class="col-lg-6">
                                     <div class="form-group">
                                            ...
                                            <input type="text" id="datepicker" required="" name="date" class="hasDatepicker">
                                            <label>To Date</label>
                                            <input type="text" id="datepicker2" required="" name="date" class="hasDatepicker"></div>
                                            
                                            <div class="form-group">
                                            <label>Bank Account</label>
                  <select id="head" data-placeholder="Choose a Country" class="form-control chzn-select" tabindex="-1" name="head_one" style="display: none;">
                                          
                                            <option value="">Select Bank</option>
                                            <option value="3">HBL-KARWAN</option>
						                    <option value="2">ABL AZMAT ROAD BRANCH</option>
						                    </select><div class="chosen-container chosen-container-single" style="width: 649px;" title="" id="head_chosen"><a class="chosen-single" tabindex="-1"><span>Select Bank</span><div><b></b></div></a><div class="chosen-drop"><div class="chosen-search"><input type="text" autocomplete="off" tabindex="2"></div><ul class="chosen-results"></ul></div></div><br><br>
                                              <a href="#" onclick="loadcat22()" class="btn btn-primary">VIEW</a>
                                         </div>
...
var id= $('#head').val();
var id1= $('#datepicker').val();
var id2= $('#datepicker2').val();

$.ajax({
      type : 'POST',
      data : {val1:id,val2:id1,val3:id2},
      url  : 'fetch_bank_ledgers.php',
