        ...
        <div class="container">
	      ...
	      <div class="col-md-9">
              <div class="box box-primary">
                ...
                <div class="box-body">
                  <!-- Date range -->
                  <form method="post" action="producttransaction_add.php">
					 ...
					 <div class="col-md-6">
						  <div class="form-group">
							<label for="date">Select Item</label>
								...
								<select class="form-control select2" name="pc_name" tabindex="1" autofocus required>
								<?php
                  ...
                  $cust_name = $_REQUEST['cust_name'];
								...
								?>
										<option style="font-size:12px;" value="<?php echo $row['pc_id'];?>"><?php echo $row['product_name']."(".$row['sc_name'].")"."(".$row['pc_code'].")"." Available(".$row['prod_qty'].")";?></option>
                      <?php }?>
								</select>
...
<?php
		...
		$query=mysqli_query($con,"select * from temp_trans natural join productcode natural join pdsubcat natural join stproducts where branch_id='$branch'")or die(mysqli_error());
			$grand=0;
		while($row=mysqli_fetch_array($query)){
