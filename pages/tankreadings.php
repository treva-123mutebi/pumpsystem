				  ...
				  <form method="post">
                    ...
                    <div class="form-group">
							<label for="date">Select Tank</label>
							 <select class="form-control select2" style="width: 100%;" name="stunit_id" required>
              
                <?php
            
              $queryc=mysqli_query($con,"select * from storageunits ORDER BY stunit_id ASC")or die(mysqli_error());
                while($rowc=mysqli_fetch_array($queryc)){
                ?>
                  <option value="<?php echo $rowc['stunit_id'];?>"><?php echo $rowc['storageunitname'];?></option>
                <?php }?>
              </select>
...
?>      
				  ...
				  <h5><b>Tank  Readings   Report as of <?php echo date("M d, Y",strtotime($start))." to ".date("M d, Y",strtotime($end));?></b></h5>
      ...
      <thead>
                    ...
                    <tbody>
<?php
	$query=mysqli_query($con,"select * from tankreadings natural join storageunits natural join stationproducts  where date(date)>='$start' and date(date)<='$end'  and stunit_id='$prod_id' order by tankreading_id asc")or die(mysqli_error($con));
...
?>
            ...
            <td><?php echo $row['storageunitname'];?></td>
                                            ...
                                            <td><?php echo $row['openinvoice'];?></td>
                                            <td><?php echo $row['dippmorn'];?></td>
                                            <td><?php echo $row['morndiff'];?></td>
                                            <td><?php echo $row['dippeven'];?></td>
                                            <td><?php echo $row['closinginvoice'];?></td>
                                            <td><?php echo $row['cummdiff'];?></td>
                                            <td><?php echo $row['dailydiff'];?></td>
