...
<?php
		...
		$query=mysqli_query($con,"select * from dailysales natural join pumps natural join nosals  natural join stationproducts natural join shifts where Month(date) = '$month' and Year(date) = '$year' and nosal_id='$nosal_id'  ORDER BY  date desc ")or die(mysqli_error());
			$grand=0;
