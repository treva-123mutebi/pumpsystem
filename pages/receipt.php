...
<?php
    ...
    $branch=$_SESSION['branch'];
    $query=mysqli_query($con,"select * from sales natural join shifts where branch_id='$branch' order by sales_id desc LIMIT 0,1")or die(mysqli_error($con));
      
        $row=mysqli_fetch_array($query);
       
        $sales_id=$row['sales_id'];
        $last=$row['shift_details'];
...
?>    
                  ...
                  <table class="table">
                    ...
                    <tbody>
<?php
		$query=mysqli_query($con,"select * from sales_details natural join productcode natural join pdsubcat natural join stproducts where sales_id='$sid'")or die(mysqli_error($con));
			$grand=0;
