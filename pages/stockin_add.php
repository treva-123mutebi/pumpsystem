...
include('../dist/includes/dbcon.php');
	...
	mysqli_query($con,"UPDATE productcode SET prod_qty=prod_qty+'$qty',unitprice ='$unitprice' where pc_id='$name'") or die(mysqli_error($con)); 
			
			mysqli_query($con,"INSERT INTO stockin(pc_id,qty,unitprice,total,date,branch_id,user_id) VALUES('$name','$qty','$unitprice','$total','$date','$branch','$id')")or die(mysqli_error($con));
