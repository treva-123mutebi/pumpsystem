      ...
      <div class="content-wrapper">
        <div class="container">
	      ...
	      <div class="col-md-9">
              <div class="box box-primary">
                ...
                <div class="box-body">
                  ...
                  $date = $_REQUEST['date'];
								...
								?>
										<option value="<?php echo $row['prod_id'];?>"><?php echo $row['cat_name']." Available(".$row['prod_qty'].")"." Batch Number(".$row['prod_name'].")";?></option>
                      <?php }?>
								</select>-->
              ...
              ?>
                <!--<input type="number" class="form-control pull-right" id="date" name="qty" placeholder="Quantity" tabindex="2" value="1" min="1" max="<?php echo $row['prod_qty'];?>"  required>-->
              <?php ?>
							</div><!-- /.input group -->
						</div><!-- /.form group -->
					 </div>
...
<?php
		...
		$query=mysqli_query($con,"select * from reviewsales_details natural join reviewsales natural join productcode natural join pdsubcat natural join stproducts where branch_id='$branch' and reviewstatus='approved' or 'declined' ")or die(mysqli_error());
			$grand=0;
		while($row=mysqli_fetch_array($query)){
				$id=$row['reviewsalesdetails_id'];
...
?>                    
            ...
            <td class="record"><?php echo $row['pc_code'];?></td>
              <td class="record"><?php echo $row['product_name'];?> <?php echo $row['sc_name'];?> </td>
