...
<html>
  <head>
    ...
    <title>Fuel Sale | <?php include('../dist/includes/title.php');?></title>
        ...
        <div class="container">
            ...
            <div class="col-md-4">
              <div class="box box-primary">
                ...
                <div class="form-group">
                  ...
                  <div class="form-group">
                    <label for="date">Select Pump Nosal</label>
                    <div class="input-group col-md-12">
                      <select class="form-control select2" style="width: 100%;" name="nosal_id" required>
                      <?php
                       include('../dist/includes/dbcon.php');
          ...
          <?php }?>
                  ...
                  <div class="form-group">
                    ...
                    <div class="input-group col-md-12">
                      <select class="form-control select2" style="width: 100%;" name="shift_id" required>
                      <?php
                       include('../dist/includes/dbcon.php');
