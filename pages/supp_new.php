...
<html>
  <head>
    ...
    <title>Daily tank readings| <?php include('../dist/includes/title.php');?></title>
        ...
        <div class="container">
          ...
          <section class="content-header">
            ...
            <ol class="breadcrumb">
              ...
              <li class="active">Daily Tank Readings</li>
            </ol>
          </section>
          ...
          <section class="content">
            ...
            <div class="col-md-4">
              <div class="box box-primary">
                <div class="box-header with-border">
                  <h3 class="box-title">Record Daily Tank Readings</h3>
                </div>
                <div class="box-body">
                
                <form method="post" action="prod_transaction.php" enctype="multipart/form-data">
