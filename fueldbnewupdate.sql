...
--
-- Host: localhost
-- Generation Time: Feb 18, 2021 at 04:40 AM
...
(65, 2, 12, NULL, 2, 579727.44, 579785.38, NULL, 0.00, '57.94', '3830.00', '221917.86', NULL, NULL, NULL, NULL, NULL, NULL, NULL, '2021-01-01 00:00:00');
...
--
ALTER TABLE `dailysales`
  MODIFY `dailysales_id` int(25) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=66;
...
--
ALTER TABLE `lastclosinginvoice`
  MODIFY `lastclosinginvoice_id` int(25) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=17;

--
-- AUTO_INCREMENT for table `lastclosingmeter`
--
ALTER TABLE `lastclosingmeter`
  MODIFY `lastclosingmeter_id` int(25) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=50;
...
--
ALTER TABLE `purchase`
  MODIFY `purchase_id` int(255) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;
...
--
ALTER TABLE `tankreadings`
  MODIFY `tankreading_id` int(25) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=19;
