...
?>    
     ...
     <table width="100%" border="1">
                <tbody><tr>
                <td width="10%"><label>Sr.</label></td>
                <td width="40%"><label>Customer</label></td>
          ...
          <br><br>
          <a target="_blank" class="btn btn-success" href="print_docs/print_rec.php">Print</a>
