...
(135, 7, 'has logged in the system at ', '2021-04-23 14:38:44'),
(136, 7, 'has logged in the system at ', '2021-04-27 00:17:53'),
(137, 7, 'Stock taking updated 1000 of OC01', '2021-04-27 03:41:35'),
(138, 7, 'added 100 of OC01', '2021-04-27 03:58:01'),
(139, 7, 'added 600 of CD001', '2021-04-27 03:59:16'),
(140, 7, 'has logged in the system at ', '2021-05-03 19:13:49');
...
(19, 2, '44641.43', '-4493.33', '40148.10');
...
(3237, 1, 98, '4,066,000.00', '2021-04-01 00:00:00', 7, 5, '2021-04-01', '4,066,000.00', NULL, NULL, 'Cash', 'dan Peter', NULL, 1961);
...
(1, 1, 'CD001', 40.00, NULL, 1090.00, 4000.00, 8, 200.00),
(2, 1, 'CD002', 20.00, NULL, 90.00, NULL, 8, 2000.00),
(3, 3, 'TK01', 100.00, NULL, 9900.00, NULL, 9, 50000.00),
(4, 2, 'OC01', 500.00, NULL, 1089.00, NULL, 8, 4000.00),
(5, 4, 'EOT001', 100.00, NULL, 10900.00, NULL, 9, 40000.00);
...
(5, 8, 3, 100.00, 3700.00, 370000.00, '2021-02-05 00:00:00');
...
(74, 1, 96, '4,060,000.00', '2021-01-21 00:00:00', 7, 5, '2021-01-21', '4,060,000.00', NULL, NULL, 'Cash', 'klaus Michealson', NULL, 10012),
(75, 1, 97, '6,000.00', '2021-04-01 00:00:00', 7, 5, '2021-04-01', '6,000.00', NULL, NULL, 'Cash', 'dan Peter', NULL, 10013);
...
(96, 1, 7, '4,060,000.00', NULL, '2021-01-21 00:00:00', 'Cash', 'klaus Michealson', 5, '4,060,000.00', 'approved'),
(97, 1, 7, '6,000.00', NULL, '2021-04-01 00:00:00', 'Cash', 'dan Peter', 5, '6,000.00', 'approved');
...
(98, 1, 7, NULL, NULL, '4,066,000.00', NULL, '2021-04-01 00:00:00', 'Cash', 'dan Peter', 5, '4,066,000.00');
...
(35, 4, 100.00, 7, '400000', '2021-01-06 00:00:00', 5),
(36, 1, 600.00, 7, '120000', '2021-01-01 00:00:00', 5);
...
(6, 4, '2021-04-26', 1000.00, 990.00, 10.00, 7);
...
(21, '27741.43', '27741.43', '0.00', '44641.43', '40148.10', NULL, '-4493.33', '-4531.25', '-16548.10', '2021-01-19 21:00:00', 2);
...
--
ALTER TABLE `lastclosinginvoice`
  MODIFY `lastclosinginvoice_id` int(25) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=20;
...
--
ALTER TABLE `payment`
  MODIFY `payment_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3238;
...
--
ALTER TABLE `purchase`
  MODIFY `purchase_id` int(255) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9;
...
--
ALTER TABLE `reviewpayment`
  MODIFY `reviewpayment_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=76;
...
--
ALTER TABLE `reviewsales`
  MODIFY `reviewsales_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=98;

--
-- AUTO_INCREMENT for table `reviewsales_details`
--
ALTER TABLE `reviewsales_details`
  MODIFY `reviewsalesdetails_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=99;
...
--
ALTER TABLE `sales_details`
  MODIFY `sales_details_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=156;
...
--
ALTER TABLE `stockin`
  MODIFY `stockin_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=37;

--
-- AUTO_INCREMENT for table `stocktaking`
--
ALTER TABLE `stocktaking`
  MODIFY `stocktaking_id` int(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;
...
--
ALTER TABLE `tankreadings`
  MODIFY `tankreading_id` int(25) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=22;
...
--
ALTER TABLE `temp_trans`
  MODIFY `temp_trans_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=159;
