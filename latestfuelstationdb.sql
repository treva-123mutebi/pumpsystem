...
(66, 1, 8, NULL, 2, 187878.62, 187895.16, NULL, 0.00, '16.53', '3830.00', '63309.90', NULL, NULL, NULL, NULL, NULL, NULL, NULL, '2021-01-02 00:00:00'),
...
INSERT INTO `payment` (`payment_id`, `shift_id`, `sales_id`, `payment`, `payment_date`, `user_id`, `branch_id`, `payment_for`, `due`, `interest`, `remaining`, `status`, `rebate`, `or_no`) VALUES
...
(1, 1, 'CD001', 40.00, NULL, 5000.00, 4000.00, 8, 200.00);
...
INSERT INTO `reviewpayment` (`reviewpayment_id`, `shift_id`, `reviewsales_id`, `payment`, `payment_date`, `user_id`, `branch_id`, `payment_for`, `due`, `interest`, `remaining`, `status`, `rebate`, `or_no`) VALUES
...
INSERT INTO `reviewsales` (`reviewsales_id`, `shift_id`, `user_id`, `amount_due`, `discount`, `date_added`, `modeofpayment`, `branch_id`, `total`, `reviewstatus`) VALUES
...
INSERT INTO `sales` (`sales_id`, `shift_id`, `user_id`, `cash_tendered`, `discount`, `amount_due`, `cash_change`, `date_added`, `modeofpayment`, `branch_id`, `total`) VALUES
...
--
ALTER TABLE `dailysales`
  MODIFY `dailysales_id` int(25) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=71;
...
--
ALTER TABLE `lastclosinginvoice`
  MODIFY `lastclosinginvoice_id` int(25) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=18;

--
-- AUTO_INCREMENT for table `lastclosingmeter`
--
ALTER TABLE `lastclosingmeter`
  MODIFY `lastclosingmeter_id` int(25) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=55;
...
--
ALTER TABLE `payment`
  MODIFY `payment_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3223;

--
-- AUTO_INCREMENT for table `pdsubcat`
--
ALTER TABLE `pdsubcat`
  MODIFY `sc_id` int(26) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
...
--
ALTER TABLE `productcode`
  MODIFY `pc_id` int(25) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
...
--
ALTER TABLE `reviewpayment`
  MODIFY `reviewpayment_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=59;
...
--
ALTER TABLE `reviewsales`
  MODIFY `reviewsales_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=81;

--
-- AUTO_INCREMENT for table `reviewsales_details`
--
ALTER TABLE `reviewsales_details`
  MODIFY `reviewsalesdetails_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=76;
...
--
ALTER TABLE `sales`
  MODIFY `sales_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=81;

--
-- AUTO_INCREMENT for table `sales_details`
--
ALTER TABLE `sales_details`
  MODIFY `sales_details_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=130;
...
--
ALTER TABLE `stockin`
  MODIFY `stockin_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=25;

--
-- AUTO_INCREMENT for table `stocktaking`
--
ALTER TABLE `stocktaking`
  MODIFY `stocktaking_id` int(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
...
--
ALTER TABLE `stproducts`
  MODIFY `stpd_id` int(25) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
...
--
ALTER TABLE `tankreadings`
  MODIFY `tankreading_id` int(25) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=20;
...
--
ALTER TABLE `temp_trans`
  MODIFY `temp_trans_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=127;
